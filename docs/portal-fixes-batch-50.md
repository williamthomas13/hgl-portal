# Portal fixes — batch 50 (CLOSED for hand-off Sep 21, 2026 — 7 items, PL-461…467)

**Standing rules:** all prior, plus the PL-460 rule (every call-to-action lands where the action can be done).

(Opened + closed Sep 21, 2026. Next PL: PL-468.)
